    ...
    public static class GlyphTags
    {
        public static ImmutableArray<string> GetTags(Glyph glyph)
        {
            switch (glyph)
            {
                ...
                case Glyph.BasicFile:                return WellKnownTagArrays.VisualBasicProject;
                ...
                case Glyph.DelegatePrivate:          return WellKnownTagArrays.DelegateProtected;
                ...
                case Glyph.MethodPrivate:            return WellKnownTagArrays.ModulePrivate;
                ...
                case Glyph.AddReference:             return WellKnownTagArrays.AddReference;
                case Glyph.NuGet:                    return WellKnownTagArrays.NuGet;
                case Glyph.None:
